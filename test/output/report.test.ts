...
function createHeapSummary(): HeapSummary {
  return {
    ...
    typeStats: [
      { type: "object", count: 50, totalSize: 4_500_000, avgSize: 90_000 },
    ],
    constructorStats: [
      { constructor: "Array", count: 10, totalSize: 3_000_000, avgSize: 300_000 },
    ],
...
describe("generateMarkdown", () => {
  ...
  test("includes footer", () => {
    expect(md).toContain("Generated by perfagent");
  });
});
